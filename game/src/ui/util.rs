...
impl Scale {
    ...
    #[inline] pub fn su(&self, n: f32) -> f32 { n * self.su }

    // ── Spacing tokens ────────────────────────────────────────────────
    #[inline] pub fn gap_xxs(&self) -> f32 { self.su(2.0) }
    #[inline] pub fn gap_xs(&self) -> f32  { self.su(4.0) }
    #[inline] pub fn gap_sm(&self) -> f32  { self.su(8.0) }
    #[inline] pub fn gap_md(&self) -> f32  { self.su(12.0) }
    #[inline] pub fn gap_lg(&self) -> f32  { self.su(16.0) }
    #[inline] pub fn gap_xl(&self) -> f32  { self.su(24.0) }

    /// Standard window padding.
    #[inline] pub fn pad_w(&self) -> f32 { self.su(16.0) }

    /// Standard button height.
    #[inline] pub fn btn_h(&self) -> f32 { self.su(40.0) }

    /// Progress bar height.
    #[inline] pub fn bar_h(&self) -> f32 { self.su(24.0) }
...
/// Bright body text.
#[inline] pub fn text_body(ui: &Ui, text: &str) { ui.text_colored([0.88, 0.90, 0.96, 1.0], text); }
/// Muted secondary text.
#[inline] pub fn text_muted(ui: &Ui, text: &str) { ui.text_colored([0.50, 0.56, 0.68, 0.70], text); }
/// Dim label text.
#[inline] pub fn text_dim(ui: &Ui, text: &str) { ui.text_colored([0.36, 0.42, 0.56, 0.7], text); }
...
/// Vertical gap.
#[inline] pub fn gap(ui: &Ui, h: f32) { ui.dummy([0.0, h]); }
